...
void ::Thermostat::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::Thermostat::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
        ...
        case 1:
            {
                ...
                (safe_cast<::Windows::UI::Xaml::Controls::Page^>(element1))->Loaded += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::Thermostat::MainPage::*)
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::Thermostat::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
